...
using ins_config = table_config<size_t, size_t, utils_tm::hash_tm::default_hash,
                                allocator_type>;
...
template <class Hash> int fill(Hash& hash, size_t end)
{
    auto err = 0u;
...
template <class Hash> int find_unsucc(Hash& hash, size_t end)
{
    auto err = 0u;
...
template <class Hash> int find_succ(Hash& hash, size_t end)
{
    auto err = 0u;
